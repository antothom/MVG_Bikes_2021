...
# Mean amount of rides on specific weekdays for each month
...
- Create clusters of usage areas (Start- and End-Point)
- One Cluster for each Month and Weekday --> Identify the most relevant Clusters
```{r Usage Area Clustering}
...
df_rides_2021_cl%>%
  ...
  geom_vline(xintercept = 10, colour = "black",  linetype="dotted") +
